...
class UpdateChampionRequest extends FormRequest
{
    ...
    {
        $champion = $this->route('champion');
        $championId = $champion instanceof Champion ? $champion->id : $champion;
        ...
        return [
            'name' => [
                ...
                'string',
                'max:100',
                Rule::unique('champions', 'name')->ignore($championId),
            ],
    ...
    public function messages(): array
    {
        return [
            ...
            'name.unique' => 'Ya existe otro campeón registrado con este nombre.',
            'title.required' => 'El título oficial es obligatorio.',
